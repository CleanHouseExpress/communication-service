...
class ConversationResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'handoff_requested_by' => $this->handoff_requested_by,
            'handoff_requested_reason' => $this->handoff_requested_reason,
            ...
            'handoff_assigned_at' => $this->handoff_assigned_at?->toIso8601String(),
